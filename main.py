...
bot = TeleBot(token='Введи свой токен', parse_mode='html') # создание бота
...
DEFINITOINS = {
    ...
    'цель тестирования': 'получение актуальной информации о состоянии продукта на данный момент',
    'тест-кейс':'четкое описание действий, которое необходимо выполнить для проверки функционала',
}
...
def message_handler(message: types.Message):
    ...
    if definition is None:
        ...
        bot.send_message(
            ...
            text='Ммм, я пока не знаю такого определения 😜',
        )
        # выходим из функции
        return
    ...
    bot.send_message(
        chat_id=message.chat.id,
        text=f'Могу еще что-нибудь подсказать? 📚',
    )
